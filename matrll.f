...
c       in that it only stores half of the matrix. (DJS)
c
...
c
c             fld :   |lr-lc| .le. 2
c                     fld => Liouville operator matrix element may exist
c                            (L-bandwidth of 2 comes from spin operators
c                            of rank 0 and 2)
c
c             fldmd : fld .or. (mr.eq.mc)
c                     fldmd => Liouville or diffusion operator matrix
c                              element may exist
c
c             flk0 :  (lr.eq.lc) .and. (kr.eq.kc)
c                     flk0 => Liouville (A-tensor), diffusion, or Heisenberg
c                             spin exchange matrix elements may exist
c
c       ----------------------------------------
...
c
     ...
     #        ipnd,ipns,ipndab,ipnsab,iqnd,iqns,iqndab,iqnsab,kip,
     #        nrow,ncol,nelr,neli,nel
      integer ioldlr,ioldkr,ioldmr,ioldpnr,ioldlc,ioldkc,ioldmc,
     #        ioldpnc,ipnrsg,ipncsg,iparlr,iparlc,
     #        jkd,jmd,kcsgn,krsgn,mcsgn,mrsgn,lcmax
c
      double precision dsq2,dsq6,dsq8,dsq15,dsq23
      double precision ct,rpl,rmi,rz,rj,rp,ossc,fii,pmxl,pmz,pmxk,ra0,
     #     cplkr,cpkr,cplmr,cpmkr,cpmr,cnpr,c1,c2,c3,c4,
     #     cdfd,cnl,cplkc,cnk,z,ra1,rg1,ra2,rg2,rw1,rw2,
     #     ra,rg,rw,cliou,cgam,cplmc,wliou1,wliou2,cdff,cdffr,
     #     cdffu,cnpc,cnp,cnorm,d1,d2,sa1,sa2,clioi1,fki,
     #     clioi2,clioua,sg1,sg2,sw1,sw2,clioug,cgamw,ctemp
...
c
c              -------------------------------------
c              Add in off-diagonal diffusion terms 
c              -------------------------------------
