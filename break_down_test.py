...
pynlsl.procline("log sampl1")
print
print('  --- Set magnetic parameters for CSL spin probe \n')
print('********************************************')
print('Magnetic parameters for CSL spin probe')
print('********************************************')
pynlsl.procline("let gxx,gyy,gzz=2.0089,2.0021,2.0058")
pynlsl.procline("let in2=2")
pynlsl.procline("let axx,ayy,azz=5.6,33.8,5.3")
pynlsl.procline("let betad=15")
print('********************************************')
...
pynlsl.procline("let gib0 = 1.5")
print
print('  --- Specify basis set truncation parameters\n')
pynlsl.procline("let lemx,lomx,kmx,mmx=6,5,4,2,2")
print
...
pynlsl.procline("data sampl1 ascii nspline 200 bc 20 shift")
print
print('   --- Specify parameters to be varied in fitting procedure\n')
pynlsl.procline("vary rpll, rprp, gib0")
print
...
pynlsl.procline("fit maxit 40 maxfun 1000 ftol 1e-3 xtol 1e-3")
