...
!                         function GETIPR
!                    =========================
!>@brief Given a parameter index and a site/spectrum index, this
!> function returns the integer parameter value from the iparm array
!> (for site parameters) or the corresponding spectral arrays for
!> spectrum parameters.
!----------------------------------------------------------------------
      integer function getipr(ixparm,ixsite)
